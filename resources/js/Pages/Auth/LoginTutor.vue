    ...
    <div class="flex">
        ...
        <div class="w-3/5 p-3 flex flex-col gap-4">
            ...
            <div class="flex flex-col w-4/5 self-center">
                ...
                <input class="p-3 bg-gray-200 border-2 border-gray-200 rounded-lg  focus:bg-white focus:border-gray-200 focus:outline-none" id="email" name="email" type="email" placeholder="Digite seu e-mail"/>
            </div>

            <div class="flex flex-col w-4/5 self-center mt-2">
                <label for="password" class="self-start">Senha</label>
                <input class="p-3 bg-gray-200 border-2 border-gray-200 rounded-lg w- focus:bg-white focus:border-gray-200 focus:outline-none" id="password" name="password" type="password" placeholder="Digite sua senha"/>
            </div>
